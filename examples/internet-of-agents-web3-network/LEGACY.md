# Historical fixture console

This is the retained design and file-format reference for the older console.
Its seeded history, static reports and attached settlement fixtures are not
execution evidence. Use [the current application](application/README.md) for
actual receipt, federation, delegation, escrow and recovery behavior.

The old console remains available for its fixture-format tests. Its generator is
`legacy_orchestrate.py`; it is not the public application entrypoint.
