...
/-- Paper-facing name for the production-shaped treaty intersection theorem. -/
...
/-- Paper-facing name for stability above the declared governance-mode floor. -/
...
/-- Paper-facing name for exact refinement on the carried finite domain. -/
...
/-- Paper-facing name for fail-closed rejection after a failed decision. -/
