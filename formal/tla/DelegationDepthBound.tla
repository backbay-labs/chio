...
(*   - links, attenuation -> crates/core/chio-core-types/src/capability.rs      *)
(*                            (DelegationLink, ScopeAttenuation,           *)
(*                             validate_delegation_chain)                   *)
(*   - revoked          -> crates/trust/chio-revocation-oracle/src/api.rs        *)
(*   - observed         -> crates/kernel/chio-kernel-core/src/revocation_view.rs  *)
