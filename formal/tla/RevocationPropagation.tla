...
(* relation, and three named safety invariants:                            *)
(*                                                                          *)
(*   - NoAllowAfterRevoke                                                   *)
(*   - MonotoneLog                                                          *)
...
(* nested directly under WF_vars (a previous form                          *)
(* WF_vars(\E m \in pending : Propagate(m)) was rejected and replaced with  *)
(* this lifted form).  Liveness is checked in the nightly                  *)
...
(*   - state, depth     -> crates/core/chio-core-types/src/capability.rs        *)
...
(* three named invariants above and does not alter Spec or Init.         *)
(* Apalache checks it in the same `--inv=` set as the existing safety    *)
(* invariants.                                                             *)
(***************************************************************************)
RevocationFreshness ==
    \A a \in ProcSet, c \in CapSet :
