...
$\mathit{KernelKeys},$
$\mathit{LeaseEpoch})$
and let $E$ be a bilateral envelope. The verifier accepts iff
\begin{align*}
  \mathit{accept}(\mathcal{S},E) \iff{}
  & \mathit{canonical}(E.\mathit{payload}) \;\wedge \\
  & E.\mathit{predicateType} = \mathit{ChiodosBilateralV1} \;\wedge \\
  & |E.\mathit{sigs}|=2 \;\wedge \\
  & E.\mathit{sig}_1.\mathit{kid} \ne E.\mathit{sig}_2.\mathit{kid} \;\wedge \\
  & E.\mathit{sig}_1.\mathit{kid} \in \mathit{IssuerKeys} \;\wedge \\
  & E.\mathit{sig}_2.\mathit{kid} \in \mathit{KernelKeys} \;\wedge \\
  & E.\mathit{payload}.\mathit{lease}.\mathit{epoch} \ge \mathcal{S}.\mathit{LeaseEpoch} \;\wedge \\
  & E.\mathit{subjectDigest} = \\
  & \quad H(\mathit{canonical}(E.\mathit{payload}.\mathit{bindingTuple})).
\end{align*}
