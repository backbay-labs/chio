...
A companion technical paper \cite{TODO_chio_parent_paper} develops the substrate in detail.
...
and a Lean theorem \cite{TODO_chio_parent_paper} establishes that the derived capability cannot grant rights
