...
| R4-MAJOR-5a | MAJOR | chio-ladder primitive missing in code. | `W3-lane-c-fixes.md` § "R4 MAJORs - Finding 5a". release work-C1.3 effort bumped M->L; primitive lives in `examples/chiodome-bilateral/src/ladder.rs`; bounded-claim text. | CLOSED | Production primitive deferred to trj6. |
