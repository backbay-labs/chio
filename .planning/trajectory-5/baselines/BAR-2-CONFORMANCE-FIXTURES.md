...
This file records the CURRENT (pre-trj5) state of Bar 2 so the post-trj5
...
Pre-trj5, ZERO of four are protected by such a fixture.
...
| Expected post-trj5 fixture path | `crates/chio-conformance/tests/single_entry_verifier_no_bypass.rs` |
...
| Expected post-trj5 fixture path | `crates/chio-conformance/tests/receipt_v2_fail_closed_under_negotiated_v2.rs` |
...
| Expected post-trj5 fixture path | `crates/chio-conformance/tests/anchor_batch_async_only_with_public_witness.rs` |
...
| Expected post-trj5 fixture path | `crates/chio-conformance/tests/bilateral_dsse_pae_only_is_conformant.rs` |
...
| Metric | Baseline (pre-trj5) | Target (post-trj5) |
|---|---|---|
