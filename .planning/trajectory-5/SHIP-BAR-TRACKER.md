...
The tracker is consumed by `scripts/check-trj5-ship-bar.sh` (companion to `scripts/trj5-preflight.sh`; both are required for release closeout). The script:
