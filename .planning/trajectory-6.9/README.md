# Chio 6.9 Relay Operations

## Baseline

- Branch: `codex/chio-6-9-relay-operations`
...
- `bash scripts/check-chio-pheromone-relay-ops.sh`
- `bash scripts/check-chio-pheromone-relay-ops.sh --schema-only`
- `bash scripts/check-chio-pheromone-relay-ops.sh --negative-only`
