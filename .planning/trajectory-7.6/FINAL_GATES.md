...
- `bash scripts/check-chiodos-treaty-bound-provenance.sh`
- `bash scripts/check-chiodos-treaty-bound-provenance.sh --schema-only`
- `bash scripts/check-chiodos-treaty-bound-provenance.sh --negative-only`
