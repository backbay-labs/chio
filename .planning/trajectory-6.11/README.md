# Chio 6.11: Relay Observability And Operator Dashboard

Baseline SHA: `5c29d7edc2085ea21029403592365668c6df896a`

Branch: `codex/chio-6-11-relay-observability`
...
- `bash scripts/check-chio-pheromone-relay-observability.sh`
- `bash scripts/check-chio-pheromone-relay-observability.sh --schema-only`
- `bash scripts/check-chio-pheromone-relay-observability.sh --negative-only`
