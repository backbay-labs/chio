# Chio 6.12 Relay Alert Routing

## Baseline

- Branch: `codex/chio-6-12-relay-alert-routing`
...
- `bash scripts/check-chio-pheromone-relay-alert-routing.sh`
- `bash scripts/check-chio-pheromone-relay-alert-routing.sh --schema-only`
- `bash scripts/check-chio-pheromone-relay-alert-routing.sh --negative-only`
