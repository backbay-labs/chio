...
These entries are deliberately listed ONLY in this section. They were
removed from the consolidated-main replay ledger above so closeout
tooling and reviewers do not mistake the CI-only consolidated green run
for full reconciliation of these PRs' gating workflows. Each PR below
remains a real piece of CI debt until its non-CI gate is individually
replayed or formally deferred.
