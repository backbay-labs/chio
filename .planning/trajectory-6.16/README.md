# Chio 6.16 Alert Assurance Export

Baseline: `main@df0e1cc61ded5bba6424e26f7ca338e6d09f139e`

Branch: `codex/chio-6-16-alert-assurance-export`
...
- CLI commands under `chio pheromone relay alert assurance`.
...
- `cargo test -p chio-cli --bin chio_pheromone_relay_alert_assurance_export`
- `cargo test -p chio-spec-validate`
- `cargo test -p chio-metrics-spec`
- dashboard tests and build
- `bash scripts/check-chio-pheromone-relay-alert-assurance-export.sh`
- `bash scripts/check-chio-pheromone-relay-alert-assurance-export.sh --schema-only`
- `bash scripts/check-chio-pheromone-relay-alert-assurance-export.sh --negative-only`
