...
required_environment=(
  ...
  CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_ID
  CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_SECRET
  GITHUB_RUN_ID
  GITHUB_RUN_ATTEMPT
)
...
env \
  ...
  -u CHIO_FINDING_NETWORK_ISOLATION_TENANT_ID \
  -u CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_ID \
  -u CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_SECRET \
...
canary_environment=(
  ...
  "CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_ID=${CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_ID}"
  "CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_SECRET=${CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_SECRET}"
...
env -i "${canary_environment[@]}" "${canary_bin}" \
  ...
  --isolation-tenant-id "${CHIO_FINDING_NETWORK_ISOLATION_TENANT_ID}" \
  --isolation-buyer-key-id-env CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_ID \
  --isolation-buyer-key-secret-env CHIO_FINDING_NETWORK_ISOLATION_BUYER_KEY_SECRET \
