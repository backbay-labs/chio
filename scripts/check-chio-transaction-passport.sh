...
agent_web_fixture_timestamp=1770508800
agent_web_verifier_now="${CHIO_AGENT_WEB_STANDARD_WEBHOOKS_NOW_UNIX_SECONDS:-$(($(date +%s) + 60))}"
export CHIO_AGENT_WEB_STANDARD_WEBHOOKS_NOW_UNIX_SECONDS="$agent_web_verifier_now"
export CHIO_AGENT_WEB_STANDARD_WEBHOOKS_MAX_AGE_SECONDS="${CHIO_AGENT_WEB_STANDARD_WEBHOOKS_MAX_AGE_SECONDS:-$((agent_web_verifier_now - agent_web_fixture_timestamp + 300))}"
unset agent_web_fixture_timestamp agent_web_verifier_now
