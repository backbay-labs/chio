...
cargo run -p chio-cli -- chiodos authority issue \
...
cargo run -p chio-cli -- chiodos authority checkpoint \
  --profile "$tmpdir/input/authority-profile.json" \
...
cargo run -p chio-cli -- chiodos authority trust-bundle assemble \
  --profile "$tmpdir/input/authority-profile.json" \
...
print("OK Chiodos authority issuance artifacts")
PY
