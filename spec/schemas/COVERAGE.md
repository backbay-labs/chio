...
| `chio-finding/v1/`      |    1  | Signed cognition-market finding artifact with content-address, evidence-reference, and issuer-signature constraints. |
...
| `registry.json`               |  2049 | Verifier-facing registry of signed artifact schema IDs and their schema files. |
