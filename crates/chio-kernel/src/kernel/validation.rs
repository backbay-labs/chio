//! `ChioKernel` capability, budget, and governed-admission validation.
//!
//! Holds capability issuance/revocation, the budget charge/reconcile
//! helpers, and the governed approval / autonomy / transaction / call-chain
//! validators. Method bodies are moved verbatim from `kernel/mod.rs`;
