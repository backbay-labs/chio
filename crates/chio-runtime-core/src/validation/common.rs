...
pub(crate) fn rejected<T>(code: &'static str, detail: &str) -> Result<T, ChioRuntimeError> {
...
pub(crate) fn ensure_sha256_hash(hash: &str, code: &'static str) -> Result<(), ChioRuntimeError> {
...
pub(crate) fn validate_non_empty(value: &str, code: &'static str) -> Result<(), ChioRuntimeError> {
