...
kernel-mediated cross-vendor workflows. It holds the implementation behind the
public `chio-runtime` facade: admission, trust-floor enforcement, orchestration,
operations, and proof regeneration.
