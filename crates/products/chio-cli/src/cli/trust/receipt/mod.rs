...
pub(crate) use explain::{
    ...
    json_path_str, load_receipt_for_explain, print_bilateral_human,
    push_receipt_explain_matches, receipt_value_matches_id, render_bilateral_explain,
    repair_hint, ReceiptExplainArgs,
};
#[cfg(test)]
#[allow(unused_imports)]
...
pub(crate) use format::{
    ...
    render_receipt_health_human, ReceiptOperatorJsonEnvelope,
...
pub(crate) use health::{
    ...
    cmd_receipt_flush, cmd_receipt_health, load_existing_kernel_checkpoint_keypair,
    local_receipt_store, receipt_checkpoint_report_error, receipt_health_report_error,
};
#[allow(unused_imports)]
