...
pub(crate) fn cmd_chiodos_runtime_ops_provider_health(
    ...
    cmd_chio_runtime_ops_provider_health(supervisor_profile, provider_bindings, now_unix_ms, report)
}
...
pub(crate) fn cmd_chiodos_runtime_ops_retention_plan(
    ...
    cmd_chio_runtime_ops_retention_plan(retention_profile, store, evidence_root, now_unix_ms, report)
}
