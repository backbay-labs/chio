...
pub(crate) use self::alerts::{
    ...
    cmd_chiodos_pheromone_relay_alert_evaluate, cmd_chiodos_pheromone_relay_alert_handoff,
    cmd_chiodos_pheromone_relay_alert_normalize, cmd_chiodos_pheromone_relay_alert_review,
...
pub(crate) use self::directory::{
    ...
    cmd_chio_pheromone_relay_supervisor_lint, cmd_chiodos_pheromone_relay_directory_inspect,
    cmd_chiodos_pheromone_relay_directory_promote, cmd_chiodos_pheromone_relay_directory_reject,
    cmd_chiodos_pheromone_relay_supervisor_lint, load_relay_peer_directory_from_paths,
    write_pretty_json,
};
...
pub(crate) use self::relay::{
    ...
    cmd_chio_pheromone_relay_tick, cmd_chio_pheromone_relay_trend,
    cmd_chiodos_pheromone_relay_catchup, cmd_chiodos_pheromone_relay_enqueue,
    ...
    cmd_chiodos_pheromone_relay_status, cmd_chiodos_pheromone_relay_tick,
    cmd_chiodos_pheromone_relay_trend, read_relay_event_reports,
};
pub(crate) use self::runtime::{
    cmd_chio_pheromone_query, cmd_chio_pheromone_receive, cmd_chiodos_pheromone_query,
