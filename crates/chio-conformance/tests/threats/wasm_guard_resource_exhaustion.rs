...
//! Stub test for threat ID `wasm_guard_resource_exhaustion` (WASM guard resource exhaustion).
//!
...
unimplemented!("M05.P5.T3 must populate the test body for threat \"wasm_guard_resource_exhaustion\"");
}
