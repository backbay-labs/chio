...
//! Stub test for threat ID `tee_quote_forgery` (TEE quote forgery or misbinding).
//!
...
unimplemented!("M05.P5.T3 must populate the test body for threat \"tee_quote_forgery\"");
}
