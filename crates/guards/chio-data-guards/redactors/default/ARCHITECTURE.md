...
OpenAI-style `sk-...` and `sk-proj-...` keys redact as whole API keys before generic high-entropy matching can redact only the tail and leave the provider prefix in the output.
