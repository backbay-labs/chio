...
/// themselves, tied to the approval that governs the spend. C3
...
///
/// This type is the seam to C2: once a verified
...
/// C3 money-safety invariants before any signature is broadcast:
///
