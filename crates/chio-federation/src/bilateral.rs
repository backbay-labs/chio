...
/// they are statement fields the DSSE signature-slice envelope binds.
/// `tool_name` is typically `receipt.tool_name`; `timestamp_unix_ms` is
/// the wall-clock at canonicalisation (Org B-side).
///
