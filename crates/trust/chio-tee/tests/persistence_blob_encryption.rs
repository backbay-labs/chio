...
const OPENAI_SINGLE_TOOL: &[u8] = include_bytes!(
    "../../../protocol/chio-tool-call-fabric/fixtures/lift_lower/openai/single_tool.json"
);
const ANTHROPIC_SERVER_TOOL: &[u8] = include_bytes!(
    "../../../protocol/chio-tool-call-fabric/fixtures/lift_lower/anthropic/server_tool.json"
);
const BEDROCK_ASSUMED_ROLE: &[u8] = include_bytes!(
    "../../../protocol/chio-tool-call-fabric/fixtures/lift_lower/bedrock/assumed_role.json"
);
