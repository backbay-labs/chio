...
pub(super) use chio_federation::{
    ...
    pheromone_gossip::PheromoneTransitChain, pheromone_gossip::PheromoneTransitHop,
    pheromone_gossip::PHEROMONE_GOSSIP_BATCH_SCHEMA, pheromone_gossip::PHEROMONE_GOSSIP_SCHEMA,
};
