...
impl NativePrompt {
    ...
    pub fn arguments(mut self, arguments: Vec<chio_core::PromptArgument>) -> Self {
...
pub struct NativeChioServiceBuilder {
    server_id: String,
    server_name: String,
...
impl ResourceProvider for NativeChioService {
...
impl PromptProvider for NativeChioService {
