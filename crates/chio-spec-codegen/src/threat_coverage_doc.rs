...
//! escape-class fixture pointers. The M05.P5.T4 gate accepts
//! `partial` as PASS but the doc generator surfaces partial IDs
//! under a separate Partial heading.
...
pub fn render_threat_coverage_doc(
    ...
    body.push_str(
        "Generated by `chio-spec-codegen --threat-model-doc` (M05.P5.T5). \
         Each threat ID is grouped by coverage state. Re-run the generator \
