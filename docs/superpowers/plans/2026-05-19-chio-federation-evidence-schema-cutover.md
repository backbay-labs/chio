...
Historical `Chio-native schema IDs` IDs remain read-compatible for already signed
evidence.
...
3. Update treaty validators to accept Chio or historical Chio schema IDs.
