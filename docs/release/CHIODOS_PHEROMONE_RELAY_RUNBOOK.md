...
1. Generate the relay observability report, relay alert report, relay trend report, relay handoff report, normalized downstream evidence, delivery import report, acknowledgement report, source-bound drift report, route review packet, assurance package, signed export, verification report, replay report, retention plan, recovery drill, archive plan, closeout review, signed archive package report, extraction report, restore drill report, physical readback drill, and retention handoff review before inspecting raw store rows.
...
16. Use bounded event reports in `--report-dir` to inspect recent batch receive, catch-up, outbound delivery, and request rejection evidence.
17. Use raw SQLite inspection only after alert, trend, handoff, normalization, delivery, acknowledgement, drift-window, route review, assurance, export, verify, replay, retention, recovery drill, archive plan, closeout review, archive package verify, extraction, restore drill, physical readback, retention handoff, observability, and bounded event reports have narrowed the incident.
...
Chio produces alert handoff, delivery, review, assurance, export, replay, retention, recovery-drill, archive, closeout, archive package, extraction, restore drill, physical readback, and retention handoff readiness evidence only. Downstream Alertmanager, PagerDuty, OpsGenie, Slack, email, webhook, SIEM, and retention systems perform live notification delivery or external retention from their own credentialed configuration. The assurance package, export bundle, archive package, and restore drill reports may show downstream evidence present, missing, stale, delayed, failed, duplicated, drifted, retained, replayed, quarantined, extracted, read back, generation-contiguous, or ready for operator-managed closeout and handoff, but they must not claim a human was notified or that Chio uploaded, deleted, moved, or mutated retained evidence.
