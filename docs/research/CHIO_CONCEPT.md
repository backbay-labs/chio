...
- Optional ZK selective disclosure for sensitive deposits (proof of concentration without revealing raw indicators); see [ARC_ZK_RECEIPT_PROOFS_MEMO.md](ARC_ZK_RECEIPT_PROOFS_MEMO.md) and the BBS+/zkVM choice still open at the time of v1.1.
