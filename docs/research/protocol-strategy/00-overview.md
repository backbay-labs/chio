...
- **GitHub Actions `workflow_dispatch` egress mediation** (priority 3 in the orchestrator wave). Despite GitHub's 2026 Agentic Workflow Firewall, the agent-attribution gap is real. ([05](05-workflow-orchestrator-mediation.md))
...
5. Wave A vocabulary changes (`EventPublish` / `EventConsume`) require a `chio-manifest` schema bump. (Wave 2 answer: additive v1 to v2 bump, fail-closed via ceiling negotiation; see [09](09-event-action-schema.md).)
...
- See also: [00-overview-v2.md](00-overview-v2.md) (wave 2 synthesis), [reviews/](reviews/) (wave 3 audit), [17-agntcy-revisited.md](17-agntcy-revisited.md) (wave 4 AGNTCY follow-up)
