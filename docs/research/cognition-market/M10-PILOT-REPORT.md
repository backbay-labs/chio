...
`d5fbcb60142b0c45aa79714a61f30c8bac33fe62`. The qualifier built the `chio`
...
- Admission time: 3,557 ms minimum, 4,012.5 ms median, 4,939 ms maximum
- Recorded normal purchase time: 2,638 ms minimum, 2,878.5 ms median,
  3,052 ms maximum
