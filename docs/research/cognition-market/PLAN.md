...
> [plans/](plans/). M11 has an implemented and qualified hosted security,
> durability, custody, worker, and release boundary on its implementation
> branch, but does not activate a public multi-tenant service. M7 remains
...
| M11 | Hosted production boundary | tenant-isolated PostgreSQL jobs, remote custody, complete ACP transport, Firecracker workers, and signed canary rollback | M10 | boundary implemented on branch; public listener and full PostgreSQL domain activation remain unbuilt; plan [plans/2026-08-28-M11-hosted-production.md](plans/2026-08-28-M11-hosted-production.md) |
