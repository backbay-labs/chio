...
be vendored into the submitted repository. Seller submission and retraction
retention is limited to 256 jobs combined under an 8 GiB and 100,000-entry
package/report ceiling. The full 1 GiB and 75,000-entry transient staging
budget plus publication headroom is reserved before a new job is accepted.
Challenge artifact lookup
