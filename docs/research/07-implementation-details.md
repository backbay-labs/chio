...
This already exists structurally in [capability.rs](../../crates/core/chio-core-types/src/capability.rs), but most of the runtime path does not yet turn it into pervasive enforcement behavior.
