...
package is verified by the `chio-attest-buyer-core` verifier (exercised end
to end by the `chio-attest-loopback` and `chio-three-vendor-example` crates).
...
verified by the production `chio-attest-buyer-core` verifier
