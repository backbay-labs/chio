...
central artifact: a single source module of 583 lines, packaged as a
self-contained Lake project together with the substrate's Treaty
modules on which it depends. The bibliography file lists primary-source
...
A cold cache builds in three to five minutes; the sensor-grounded
module compiles at job ten of twenty-four in the dependency graph. The
build produces no warnings and contains no \texttt{sorry}. The
